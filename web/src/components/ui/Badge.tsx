...
const badgeVariants = {
  default:     "bg-foreground/[0.08] text-foreground/70 border-foreground/[0.10]",
  secondary:   "bg-foreground/[0.04] text-foreground/50 border-foreground/[0.07]",
  destructive: "bg-red-500/15 text-red-400 border-red-500/20",
  outline:     "text-foreground border-foreground/[0.10]",
