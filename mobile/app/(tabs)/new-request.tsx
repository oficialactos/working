  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => ({
        ...
        backgroundColor: selected ?colors.goldSoft : "rgba(255,255,255,0.035)",
    ...
    >
      <View style={{ gap: 8 }}>
        ...
        <Text selectable style={{ color: "rgba(247,242,232,0.42)", fontSize: 11, lineHeight: 17, fontWeight: "800" }}>
          {item.examples.join(", ")}...
        </Text>
      </View>
    </Pressable>
