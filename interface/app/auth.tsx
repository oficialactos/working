        ...
        <View style={{ flex: 1, flexDirection: isWide ?"row" : "column" }}>
          ...
          >
            <View style={{ width: "100%", maxWidth: 520, alignSelf: "center", gap: 30 }}>
              <View style={{ gap: 10 }}>
                <Text selectable style={{ color: isLight ? "#2F291F" : colors.text, fontSize: 42, lineHeight: 46, fontWeight: "900", letterSpacing: 0 }}>
                  {mode === "login" ?"Bem-vindo de volta" : "Vamos criar seu perfil"}
                </Text>
                <Text selectable style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.45)", fontSize: 15, lineHeight: 23, fontWeight: "800" }}>
                  {mode === "login"
              ...
              <View style={{ gap: 18 }}>
                ...
                <View style={{ height: 1, backgroundColor: isLight ? "rgba(156,117,53,0.18)" : "rgba(255,255,255,0.07)", marginVertical: 4 }} />

                <Pressable onPress={switchMode} style={{ alignItems: "center", paddingVertical: 8 }}>
                  <Text style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.48)", fontSize: 14, fontWeight: "800" }}>
                    {mode === "login" ? "Novo por aqui? " : "Ja possui uma conta? "}
...
function RegisterStep({
  ...
  return (
    <View style={{ gap: 20 }}>
      <View style={{ gap: 10 }}>
        <View style={{ height: 6, borderRadius: 999, backgroundColor: isLight ? "rgba(156,117,53,0.14)" : "rgba(255,255,255,0.08)", overflow: "hidden" }}>
          <View style={{ width: `${progress}%`, height: "100%", backgroundColor: colors.gold }} />
        </View>
        <Text style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.42)", fontSize: 12, fontWeight: "900" }}>
          Pergunta {step + 1} de {totalSteps}
        </Text>
      </View>

      <View style={{ gap: 10 }}>
        <Text selectable style={{ color: isLight ? "#2F291F" : colors.text, fontSize: 26, lineHeight: 32, fontWeight: "900", letterSpacing: 0 }}>
          {fetchingAddress && currentQuestion.field === "cep" ?"Buscando seu endereço..." : currentQuestion.title}
        </Text>
        <Text selectable style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.48)", fontSize: 14, lineHeight: 22, fontWeight: "700" }}>
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => ({
        borderRadius: 8,
        borderWidth: 1,
        borderColor: active ? "rgba(184,146,74,0.72)" : isLight ? "rgba(156,117,53,0.16)" : "rgba(255,255,255,0.08)",
    ...
    >
      <Text style={{ color: isLight ? "#2F291F" : colors.text, fontSize: 16, fontWeight: "900" }}>{label}</Text>
      <Text selectable style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.48)", fontSize: 13, lineHeight: 19, fontWeight: "700" }}>
        {description}
      </Text>
    </Pressable>
  );
...
function PrimaryButton({
  ...
  return (
    ...
    >
      <Text style={{ color: isLight ? "#1F1A12" : colors.text, fontSize: 15, fontWeight: "900" }}>{children}</Text>
    </Pressable>
  );
}
  ...
  return (
    <Pressable
      ...
      style={({ pressed }) => ({
        ...
        borderRadius: 8,
        borderWidth: 1,
        borderColor: isLight ? "rgba(156,117,53,0.16)" : "rgba(255,255,255,0.08)",
    ...
    >
      <Text style={{ color: isLight ? colors.gold : "rgba(247,242,232,0.78)", fontSize: 14, fontWeight: "900" }}>{children}</Text>
    </Pressable>
  );
}
  ...
  return (
    <View style={{ flex: 1, overflow: "hidden" }}>
      <ImageBackground
        ...
        imageStyle={{ opacity: isLight ? 0.12 : 0.16 }}
      >
        <View style={{ ...absoluteFill, backgroundColor: isLight ? "rgba(247,244,238,0.84)" : "rgba(7,9,14,0.78)" }} />
        <View style={{ zIndex: 1, gap: 26 }}>
          ...
          <Text selectable style={{ color: isLight ? "#2F291F" : colors.text, fontSize: 54, lineHeight: 55, fontWeight: "900", letterSpacing: 0 }}>
            A maior rede de{"\n"}profissionais do{"\n"}
            <Text style={{ color: isLight ? "#B88932" : "#D7B46A" }}>Brasil.</Text>
          </Text>
          <Text selectable style={{ color: isLight ? colors.muted : "rgba(247,242,232,0.48)", fontSize: 16, lineHeight: 26, fontWeight: "700", maxWidth: 430 }}>
            ...
            {[
              ...
              <View
                ...
                style={{
                  ...
                  borderRadius: 8,
                  borderWidth: 1,
                  borderColor: isLight ? "rgba(156,117,53,0.24)" : "rgba(255,255,255,0.08)",
                  backgroundColor: isLight ? "rgba(255,255,255,0.88)" : "rgba(255,255,255,0.035)",
                  padding: 16,
                  alignItems: "center",
                  gap: 6
                }}
              >
                ...
                <Text style={{ color: isLight ? "#6F5630" : "rgba(247,242,232,0.35)", fontSize: 10, fontWeight: "900", textTransform: "uppercase" }}>{item.label}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        <View
          style={{
            ...
            borderWidth: 1,
            borderColor: isLight ? "rgba(156,117,53,0.24)" : "rgba(255,255,255,0.08)",
            backgroundColor: isLight ? "rgba(255,255,255,0.90)" : "rgba(255,255,255,0.035)",
            padding: 16
          }}
        >
          <Text selectable style={{ color: isLight ? "#2F291F" : colors.text, fontSize: 13, fontWeight: "900" }}>+100 serviços concluídos agora</Text>
          <Text selectable style={{ color: isLight ? "#5E5140" : "rgba(247,242,232,0.38)", fontSize: 11, fontWeight: "800", marginTop: 4 }}>Plataforma em operação 24h</Text>
        </View>
      </ImageBackground>
    </View>
  );
